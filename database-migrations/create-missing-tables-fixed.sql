...
-- and doesn't assume column structures
-- ============================================
...
-- 3. PUNCH_LIST_CATEGORIES - Insert data only (table exists)
-- First check what columns exist, then insert accordingly
DO $$
BEGIN
  -- Try to insert with just name and display_order (no description column)
...
EXCEPTION
  WHEN OTHERS THEN
    RAISE NOTICE 'Could not insert punch_list_categories: %', SQLERRM;
END $$;
