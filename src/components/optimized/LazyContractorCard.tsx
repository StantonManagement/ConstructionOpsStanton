  ...
  <div className="bg-white rounded-lg shadow-sm border border-border p-6 animate-pulse">
    ...
    <div className="flex items-start justify-between mb-4">
      <div>
        <div className="flex items-center space-x-3 mb-2">
          <div className="h-5 bg-secondary/80 rounded w-32"></div>
          <div className="h-5 w-5 bg-secondary/80 rounded-full"></div>
        </div>
        <div className="h-3 bg-secondary/80 rounded w-24"></div>
      </div>
      <div className="flex items-center space-x-2">
        <div className="h-6 bg-secondary/80 rounded-full w-20"></div>
    ...
    <div className="space-y-2 mb-4">
      <div className="flex items-center space-x-2">
        ...
        <div className="h-3 bg-secondary/80 rounded w-28"></div>
      </div>
      <div className="flex items-center space-x-2">
        <div className="h-4 w-4 bg-secondary/80 rounded"></div>
        <div className="h-3 bg-secondary/80 rounded w-36"></div>
      </div>
    </div>
    ...
    <div className="pt-4 border-t border-border">
      <div className="h-8 bg-secondary/80 rounded-md w-full"></div>
    </div>
  </div>
));
