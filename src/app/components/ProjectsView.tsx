      ...
      {showDetailView && selectedProject ? (
        ...
        <>
          ...
          {loading ? (
            ...
            /* Projects Grid - Enhanced UX */
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredProjects.map((project) => (
                <div
                  key={project.id}
                  className="group bg-card rounded-xl border border-border p-4 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/50 transition-all duration-200 cursor-pointer relative overflow-hidden"
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1 min-w-0 pr-2">
                        <h3 className="text-base font-bold text-card-foreground truncate mb-1 group-hover:text-primary transition-colors">
                          {project.name}
                        </h3>
                      ...
                      <span className={`text-xs font-bold px-2.5 py-1 rounded-full ml-2 whitespace-nowrap shadow-sm ${
                        (project.stats?.completionPercentage ?? 0) >= 80 ? 'bg-green-500/20 text-green-700 dark:text-green-400 ring-1 ring-green-500/30' :
                        (project.stats?.completionPercentage ?? 0) >= 50 ? 'bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 ring-1 ring-yellow-500/30' :
                        'bg-blue-500/20 text-blue-700 dark:text-blue-400 ring-1 ring-blue-500/30'
                      }`}>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      <div className="text-center p-2 bg-gradient-to-br from-blue-500/10 to-blue-500/5 rounded-lg border border-blue-500/20 hover:border-blue-500/40 transition-colors">
                        <p className="text-lg font-bold text-blue-700 dark:text-blue-400">{project.stats?.totalContractors ?? 0}</p>
                        <p className="text-[10px] text-blue-600 dark:text-blue-500 font-medium uppercase tracking-wide">Contractors</p>
                      </div>
                      <div className="text-center p-2 bg-gradient-to-br from-amber-500/10 to-amber-500/5 rounded-lg border border-amber-500/20 hover:border-amber-500/40 transition-colors">
                        <p className="text-lg font-bold text-amber-700 dark:text-amber-400">{project.stats?.activePaymentApps ?? 0}</p>
                        <p className="text-[10px] text-amber-600 dark:text-amber-500 font-medium uppercase tracking-wide">Pending</p>
                      </div>
                      <div className="text-center p-2 bg-gradient-to-br from-green-500/10 to-green-500/5 rounded-lg border border-green-500/20 hover:border-green-500/40 transition-colors">
                        <p className="text-lg font-bold text-green-700 dark:text-green-400">{project.stats?.completedPaymentApps ?? 0}</p>
                        <p className="text-[10px] text-green-600 dark:text-green-500 font-medium uppercase tracking-wide">Complete</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        <span className="text-muted-foreground font-semibold flex items-center gap-1">
                          ...
                          {formatCurrency(project.stats?.totalBudget ?? 0)}
                        </span>
                        <span className={`font-bold ${
                          ...
                          {(project.stats?.completionPercentage ?? 0).toFixed(1)}% Used
                        </span>
                      </div>
                    ...
                    <div className="pt-2 border-t border-border/50">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs text-muted-foreground font-medium">{project.current_phase}</span>
                      </div>
                    </div>
                  </div>
